...
import { SessionDetailsContent } from "@/components/session-details-content"
import { SessionDetailsSidebar } from "@/components/session-details-sidebar"
...
export default function SessionDetailsPage({ params }: SessionDetailsPageProps) {
  ...
  return (
    <>
      <Header title="Session Details" description="Manage your session settings and participants." />
