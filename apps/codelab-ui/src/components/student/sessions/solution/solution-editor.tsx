...
import { FileDock } from "@/components/student/sessions/solution/file-dock";
...
`,
  ...
  const handleFileRename = (fileId: string, newName: string) => {
    setFiles((prev) =>
      prev.map((file) =>
        file.id === fileId ? { ...file, name: newName, isModified: true } : file
      )
    );
  };
        ...
        <div className="px-6 space-y-6">
          ...
          <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
            ...
            <ul className="space-y-1">
              ...
              <li>
                • Use the star icon to mark a file as the entry point for
                execution
              </li>
              <li>
                • Right-click on file tabs for more options (rename, delete,
                etc.)
              </li>
