...
import { JoinSessionButton } from "@/components/student/sessions/join-session-button";
import { SessionCardContent } from "@/components/student/sessions/session-card-content";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardFooter } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { SESSION_STATUS, SessionStatus } from "@/lib/types";
import {
  Calendar,
  CheckCircle,
  Clock,
...
const availableSessions: {
  ...
  },
  {
    ...
    courseCode: "CSC502",
    description:
      "Implement and analyze various sorting and searching algorithms with complexity analysis.",
    status: "ONGOING",
    isCollaborative: true,
  ...
  },
  {
    ...
    courseCode: "CSC501",
    description:
      "Design and propose an artificial intelligence project with detailed implementation plan.",
    status: "COMPLETED",
    isCollaborative: true,
  ...
  },
  {
    ...
    courseCode: "CSC404",
    description:
      "Comprehensive assessment of cybersecurity principles and practical security measures.",
    status: "COMPLETED",
    isCollaborative: false,
  ...
  return (
    <>
      <Header
        ...
        description="Browse and join coding sessions"
      />
      <div className="p-4 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSessions.map((session) => (
            ...
            >
              <div
                className={`${getHeaderGradient(session.status)} p-4 text-white`}
              >
