...
import { CreateGroupModal } from "@/components/student/sessions/group/create-group-modal";
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-white/80">
                Select or create a group to join this collaborative session
              </p>
            </div>
          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {group.members.map((member: any) => (
                          ...
                          >
                            <Avatar className="h-8 w-8">
                              <AvatarFallback
                                className={`${member.color} text-white text-xs`}
                              >
                                {member.avatar}
                              </AvatarFallback>
                            </Avatar>
                        ...
                        {/* Show empty slots */}
                        {Array.from({
                          length: group.maxSize - group.members.length,
                        }).map((_, index) => (
                          <div
                            key={`empty-${index}`}
