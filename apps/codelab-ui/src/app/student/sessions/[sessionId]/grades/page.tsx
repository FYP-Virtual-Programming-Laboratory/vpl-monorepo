  ...
  questions: [
    {
      ...
      status: "CORRECT",
      feedback:
        "Excellent implementation with proper balancing. Minor optimization opportunity in deletion method.",
      testCases: {
        passed: 8,
        total: 10,
      },
    },
    {
      ...
      status: "CORRECT",
      feedback:
        "Good understanding of BFS and DFS. Code is clean and well-commented.",
      testCases: {
        passed: 9,
        total: 10,
      },
    },
    {
      ...
      status: "PARTIAL",
      feedback:
        "Correct approach but inefficient time complexity. Consider memoization techniques.",
      testCases: {
        passed: 6,
        total: 10,
      },
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-600">
                        Test Cases: {question.testCases.passed}/
                        {question.testCases.total} passed
                      </span>
                    </div>
                  </div>
                  <Link href="#">
