...
function getLanguageImageDetail(id: string): LanguageImageDetail | null {
  const images: Record<string, LanguageImageDetail> = {
    "1": {
      ...
      description:
        "Python 3.9 language image for running Python code in a sandbox environment.",
      buildLogs: [
        { timestamp: "2023-10-15 14:28:10", message: "Starting build process" },
        {
          timestamp: "2023-10-15 14:28:45",
          message: "Pulling base image python:3.9-slim",
        },
    ...
    "2": {
      ...
      description:
        "JavaScript ES2021 runtime environment with Node.js 18 for executing modern JavaScript code.",
      buildLogs: [
        { timestamp: "2023-10-10 09:12:20", message: "Starting build process" },
        {
          timestamp: "2023-10-10 09:13:05",
          message: "Pulling base image node:18-alpine",
        },
        {
          timestamp: "2023-10-10 09:14:10",
          message: "Installing dependencies",
        },
        {
          timestamp: "2023-10-10 09:15:30",
          message: "Build completed successfully",
        },
      ],
    },
    "3": {
      ...
      description:
        "Java 17 development environment with OpenJDK for compiling and running Java applications.",
      buildLogs: [
        { timestamp: "2023-10-18 11:45:15", message: "Starting build process" },
        {
          timestamp: "2023-10-18 11:46:20",
          message: "Pulling base image openjdk:17-jdk-slim",
        },
        { timestamp: "2023-10-18 11:47:45", message: "Installing build tools" },
        {
          timestamp: "2023-10-18 11:48:30",
    ...
    "4": {
      ...
      description:
        "Ruby 3.1 runtime environment for executing Ruby scripts and applications.",
      buildLogs: [
        { timestamp: "2023-10-12 16:22:20", message: "Starting build process" },
        {
          timestamp: "2023-10-12 16:23:15",
          message: "Pulling base image ruby:3.1-alpine",
        },
        { timestamp: "2023-10-12 16:24:30", message: "Installing gems" },
        {
          timestamp: "2023-10-12 16:25:45",
          message: "Error: Failed to install required dependencies",
        },
    ...
    "5": {
      ...
      description:
        "Go 1.18 development environment for building and running Go applications.",
      buildLogs: [
        { timestamp: "2023-10-05 13:11:00", message: "Starting build process" },
        {
          timestamp: "2023-10-05 13:11:30",
          message: "Pulling base image golang:1.18-alpine",
        },
        {
          timestamp: "2023-10-05 13:12:15",
          message: "Setting up Go workspace",
        },
        {
          timestamp: "2023-10-05 13:13:00",
          message: "Build completed successfully",
        },
      ],
    },
...
export default function LanguageImageDetailPage() {
  ...
  const [image] = useState<LanguageImageDetail | null>(() =>
    getLanguageImageDetail(params.id as string)
  );
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            The requested language image could not be found.
          </p>
  ...
  return (
    <>
      <Header
        title="Image Details"
        description="View and manage language image configuration and build information."
      />
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 space-y-6">
          ...
          <Button
            variant="ghost"
            onClick={() => router.push("/language-images")}
            className="mb-4"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Language Images
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {image.requiresCompilation ? "Yes" : "No"}
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 flex items-center justify-between">
              <code className="text-sm font-mono text-gray-800">
                {image.executionCommand}
              </code>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => copyToClipboard(image.executionCommand)}
              >
